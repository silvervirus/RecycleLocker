...
namespace RamuneLib.Utils
{
    public static class ImageUtils
    {
        ...
        /// </summary>
        public static Sprite AsUnitySprite(this Sprite sprite) => Sprite.Create(sprite.texture, new Rect(0f, 0f, sprite.texture.width, sprite.texture.height), new Vector2(0.5f, 0.5f));
